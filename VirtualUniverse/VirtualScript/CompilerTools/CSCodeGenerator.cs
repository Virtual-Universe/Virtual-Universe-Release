...
using VirtualUniverse.ScriptEngineParser;
using Tools;

namespace VirtualUniverse.ScriptEngine.VirtualUniverse.CompilerTools
{
    ...
    public sealed class CSCodeGenerator : IDisposable
    {
                                                  ...
                                                  List<string> MethodsToAdd, string ScriptClass)
        {
            ...
            sb.AppendLine(
@"using LSL_Types = VirtualUniverse.ScriptEngine.VirtualScript.LSL_Types;
using System;
namespace Script
{
[Serializable]
public class ScriptClass : VirtualUniverse.ScriptEngine.VirtualScript.Runtime.ScriptBaseClass
{");
