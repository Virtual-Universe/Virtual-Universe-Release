...
using key = VirtualUniverse.ScriptEngine.VirtualUniverse.LSL_Types.LSLString;
using rotation = VirtualUniverse.ScriptEngine.VirtualUniverse.LSL_Types.Quaternion;
using vector = VirtualUniverse.ScriptEngine.VirtualUniverse.LSL_Types.Vector3;
...
namespace VirtualUniverse.ScriptEngine.VirtualUniverse.APIs.Interfaces
{
