...
namespace VirtualUniverse.ScriptEngine.VirtualScript
{
    public class MaintenanceThread
    {
        ...
        public VirtualUniverseThreadPool cmdThreadpool;
        private int m_CheckingEvents;
        private int m_CheckingSleepers;
        public bool m_Started;
        public VirtualUniverseThreadPool scriptChangeThreadpool;
        public VirtualUniverseThreadPool scriptThreadpool;
        ...
        public MaintenanceThread(ScriptEngine Engine)
        {
            ...
            VirtualUniverseThreadPoolStartInfo info = new VirtualUniverseThreadPoolStartInfo
            {
            ...
            cmdThreadpool = new VirtualUniverseThreadPool(info);
            info.Name = "Script Loading Thread Pools";
            scriptChangeThreadpool = new VirtualUniverseThreadPool(info);


            MaxScriptThreads = Engine.Config.GetInt("Threads", 100); // leave control threads out of user option
            VirtualUniverseThreadPoolStartInfo sinfo = new VirtualUniverseThreadPoolStartInfo
            {
                priority = ThreadPriority.Normal,
            ...
            scriptThreadpool = new VirtualUniverseThreadPool(sinfo);
