...
using VirtualUniverse.Framework.Servers.HttpServer;
using VirtualUniverse.Framework.Servers.HttpServer.Interfaces;
using VirtualUniverse.Framework.Services;
using VirtualUniverse.Framework.Services.ClassHelpers.Other;
...
namespace VirtualUniverse.Simulation.Base
{
    public class MinimalSimulationBase : ISimulationBase
    {
        ...
        protected VirtualUniverseEventManager m_eventManager = new VirtualUniverseEventManager();

        public VirtualUniverseEventManager EventManager
        {
        ...
        public virtual void Configuration(IConfigSource configSource)
        {
            ...
            VirtualUniverse.Services.BaseService consoleService = new VirtualUniverse.Services.BaseService();
            ...
            if (MainConsole.Instance != null)
            {
                ...
                MainConsole.Instance.Info(string.Format("[MINAURORA]: STARTING MIN VIRTUAL UNIVERSE ({0})...",
        ...
        public virtual void InitializeModules()
        {
            ...
            {
                var mods = VirtualUniverseModuleLoader.PickupModules(t);
        ...
        public virtual void RegisterConsoleCommands()
        {
            ...
            MainConsole.Instance.Commands.AddCommand("run configurator", "run configurator", "Runs VirtualUniverse.Configurator.",
