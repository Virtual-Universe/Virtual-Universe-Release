...
using ThreatLevel = VirtualUniverse.ScriptEngine.VirtualScript.ThreatLevel;
...
namespace VirtualUniverse.BotManager
{
    public class Bot_Api : MarshalByRefObject, IScriptApi
    {
        ...
        /// <summary>
        ///     We use "VirtualUniverse.BotManager", and that isn't a default namespace, so we need to add it
        /// </summary>
        public string[] NamespaceAdditions
        {
            get { return new string[1] { "VirtualUniverse.BotManager" }; }
        }
