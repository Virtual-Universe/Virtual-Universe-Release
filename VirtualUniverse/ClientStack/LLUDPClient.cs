...
namespace VirtualUniverse.ClientStack
{
    ...
    public sealed class LLUDPClient
    {
        ...
        /// </summary>
        //        private readonly VirtualUniverse.Framework.LocklessQueue<OutgoingPacket>[] m_packetOutboxes = new VirtualUniverse.Framework.LocklessQueue<OutgoingPacket>[(int)ThrottleOutPacketType.Count];
